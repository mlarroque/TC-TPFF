...
plt.grid(True)
plt.semilogx(medE1["f"], medE1_mag, label='medido')
plt.xticks()
plt.yticks()
plt.legend(loc = 'lower right')
datacursor(formatter="f:{x:.2f} Hz\n mag:{y:.2f} dB".format, display='multiple', draggable=True)

plt.figure(1) #GRAFICO DE ETAPA 2
plt.xlabel("Frecuencia (Hz)")
plt.ylabel("Magnitud (dB)")
plt.title("Diagrama de Magnitud - Etapa 1")
plt.semilogx(simE2["f"], simE2["mag"], label='simulado')
plt.grid(True)
plt.semilogx(medE2["f"], medE2_mag, label='medido')
plt.xticks()
plt.yticks()
plt.legend(loc = 'lower right')
datacursor(formatter="f:{x:.2f} Hz\n mag:{y:.2f} dB".format, display='multiple', draggable=True)

plt.figure(1) #GRAFICO DE ETAPA 3
plt.xlabel("Frecuencia (Hz)")
plt.ylabel("Magnitud (dB)")
plt.title("Diagrama de Magnitud - Etapa 1")
plt.semilogx(simE3["f"], simE3["mag"], label='simulado')
plt.grid(True)
plt.semilogx(medE3["f"], medE3_mag, label='medido')
plt.xticks()
plt.yticks()
plt.legend(loc = 'lower right')
datacursor(formatter="f:{x:.2f} Hz\n mag:{y:.2f} dB".format, display='multiple', draggable=True)

plt.figure(1) #GRAFICO DE ETAPA 4
plt.xlabel("Frecuencia (Hz)")
plt.ylabel("Magnitud (dB)")
plt.title("Diagrama de Magnitud - Etapa 1")
plt.semilogx(simE4["f"], simE4["mag"], label='simulado')
plt.grid(True)
plt.semilogx(medE4["f"], medE4_mag, label='medido')
plt.xticks()
plt.yticks()
plt.legend(loc = 'lower right')
datacursor(formatter="f:{x:.2f} Hz\n mag:{y:.2f} dB".format, display='multiple', draggable=True)

plt.figure(1) #GRAFICO DE ETAPA 5
plt.xlabel("Frecuencia (Hz)")
plt.ylabel("Magnitud (dB)")
plt.title("Diagrama de Magnitud - Etapa 1")
plt.semilogx(simE5["f"], simE5["mag"], label='simulado')
plt.grid(True)
plt.semilogx(medE5["f"], medE5_mag, label='medido')
plt.xticks()
plt.yticks()
plt.legend(loc = 'lower right')
datacursor(formatter="f:{x:.2f} Hz\n mag:{y:.2f} dB".format, display='multiple', draggable=True)

plt.figure(1) #GRAFICO DE ETAPA 6
plt.xlabel("Frecuencia (Hz)")
plt.ylabel("Magnitud (dB)")
plt.title("Diagrama de Magnitud - Etapa 1")
plt.semilogx(simE6["f"], simE6["mag"], label='simulado')
plt.grid(True)
plt.semilogx(medE6["f"], medE6_mag, label='medido')
plt.xticks()
plt.yticks()
plt.legend(loc = 'lower right')
datacursor(formatter="f:{x:.2f} Hz\n mag:{y:.2f} dB".format, display='multiple', draggable=True)
...
plt.figure(1) #GRAFICO DE ETAPAS JUNTAS
plt.xlabel("Frecuencia (Hz)")
plt.ylabel("Magnitud (dB)")
plt.title("Diagrama de Magnitud - Etapa 1")
plt.semilogx(simTOTAL["f"], simTOTAL["mag"], label='simulado')
plt.grid(True)
plt.semilogx(medTOTAL["f"], medTOTAL_mag, label='medido')
plt.xticks()
plt.yticks()
plt.legend(loc = 'lower right')
datacursor(formatter="f:{x:.2f} Hz\n mag:{y:.2f} dB".format, display='multiple', draggable=True)
